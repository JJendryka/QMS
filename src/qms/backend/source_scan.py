"""Contains SourceScanner and helpers."""
...
class SourceScannerSignals(QObject):
    """Class containing signals needed for SourceScanner.

    SourceScanner cannot hold them as it isn't a QObject.
    """
...
class SourceScanner(QRunnable):
    """SourceScanner QRunnable used to preform source current vs voltage scan."""
